...
function HomeDelights() {
    return (
        <div className='footer'>
            <div className="last">
                <ul className="last-1" style={{ listStyleType: "none", padding: "0px 0px 0px 150px" }}>
                    <li><p style={{fontSize:"50px"}}>
                    <svg
                        width="149"
                        height="38"
                        viewBox="0 0 149 38"
                    ...
                    <li>
                    <p style={{ fontSize: "40px", fontWeight: "bold", margin: "20px 0",color: "white"}}>
                    Bringing the Best<br /> to Your Home<br /> Delights.
                    </p>
                    </li>
                    <li>
                        <p
            ...
            Experience the finest flavors without leaving home.<br />
            Our premium selection of fresh fruits and vegetables<br />
            brings culinary excellence directly to your doorstep.<br />
            Elevate your meals with the best nature has to offer,<br />
            conveniently delivered for your enjoyment.
            </p>
            </li>
            </ul>
            </div>
            <ul className="last-menu" style={{textDecoration: "none",listStyleType: "none",color: "rgb(215, 221, 223)"}}>
                <h2 className="menu-title">
                    Menu
                </h2>
                <li>
                    <Link to="/Fresh" style={{color:"inherit",textDecoration:"none"}}>Home</Link>
                </li>
                <li>
            ...
            <div className="last-menu1">
                <h1 className="contact-title" >
                    Contact
                </h1>
                <ul style={{listStyle:"none",paddingBottom:"0px"}}>
                    <li>
                    ...
                    <li>freshtodoor@fresh.in</li>
                    <li>+ 12345 67890</li>
                </ul>
                <ul className="last-menu2">
                    <li>
                        <a href="#" aria-label="Facebook" style={{color:"inherit",textDecoration:"none"}}>
                            <FontAwesomeIcon icon={faFacebook} />
                        </a>
                    </li>
                    <li>
                        <a href="#" aria-label="Instagram" style={{color:"inherit",textDecoration:"none"}}>
                            <FontAwesomeIcon icon={faInstagram} />
                        </a>
                    </li>
                    <li>
                        <a href="#" aria-label="Twitter" style={{color:"inherit",textDecoration:"none"}}>
